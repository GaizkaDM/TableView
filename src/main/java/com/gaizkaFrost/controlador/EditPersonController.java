    ...
    public class EditPersonController {
        ...
        private void handleSave() throws SQLException {
            try {
                ...
                new Alert(Alert.AlertType.INFORMATION, "Persona actualizada correctamente.").showAndWait();
                closeWindow();

            } catch (IllegalArgumentException e) {
                logger.warn("Datos inválidos al actualizar: {}", e.getMessage());
                new Alert(Alert.AlertType.WARNING, "Datos inválidos:\n" + e.getMessage()).showAndWait();

            } catch (Exception e) {
                logger.error("Error inesperado en edición: {}", e.getMessage(), e);
                new Alert(Alert.AlertType.ERROR, "Error inesperado:\n" + e.getMessage()).showAndWait();
            }
        }
